import { onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, createTextVNode, createVNode, toDisplayString, openBlock, createBlock } from "vue";
...
import _sfc_main$8 from "./DeleteUserForm-DFRCl3Sh.js";
import _sfc_main$7 from "./UpdatePasswordForm-CYYEVMV-.js";
import _sfc_main$6 from "./UpdateProfileInformationForm-BwLAAesb.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="min-h-screen bg-gray-100"><nav class="bg-white border-b border-gray-100"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex justify-between h-16"><div class="flex"><div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">`);
