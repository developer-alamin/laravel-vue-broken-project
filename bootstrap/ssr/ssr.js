...
var e = String.prototype.replace, r = /%20/g, n = "RFC3986", o = { default: n, formatters: { RFC1738: function(t4) {
  ...
  if ("function" == typeof a2 ? w2 = a2(r2, w2) : w2 instanceof Date ? w2 = l2(w2) : "comma" === n2 && p(w2) && (w2 = f.maybeMap(w2, function(t4) {
    ...
    if (o2)
      return u2 && !g2 ? u2(r2, m.encoder, v2, "key", y2) : r2;
    w2 = "";
  }
    ...
    if (u2) {
      ...
      if ("comma" === n2 && g2) {
        for (var O2 = h.call(String(w2), ","), E2 = "", S2 = 0; S2 < O2.length; ++S2)
          E2 += (0 === S2 ? "" : ",") + b2(u2(O2[S2], m.encoder, v2, "value", y2));
        return [b2($2) + "=" + E2];
      }
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Admin/Customers/Create.vue": () => import("./assets/Create-BH-KMKbm.js"), "./Pages/Admin/Customers/Edit.vue": () => import("./assets/Edit-tSwHjEHS.js"), "./Pages/Admin/Customers/Index.vue": () => import("./assets/Index-BX7Ih6yS.js"), "./Pages/Admin/Home.vue": () => import("./assets/Home-DHBNy6Hv.js"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-C4II2c_O.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-OdoImANq.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-sLFUdBIJ.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register--nTE_7T6.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-BQUqu_FV.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-Pr8vIlnU.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-tU4EJ4EA.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DFRCl3Sh.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-CYYEVMV-.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-BwLAAesb.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-Cugt85y_.js") })),
